    ...
    <div className="flex items-center justify-center min-h-screen p-4">
      <div className="glass p-8 rounded-2xl flex flex-col items-center gap-6 relative overflow-hidden">
        ...
        <div className="text-center z-10 mb-2">
          <h1 className="text-3xl font-bold text-glow tracking-tight text-white mb-2">Join StudyAI</h1>
          <p className="text-muted-foreground text-sm">Start managing your studies with AI today.</p>
        </div>
        
        <div className="z-10 w-full flex justify-center">
          <SignUp fallbackRedirectUrl="/dashboard" signInUrl="/sign-in" appearance={{
            elements: {
